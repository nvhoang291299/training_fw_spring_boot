...
public class AccountController {
    ...
    // - Create a Counter from the MeterRegistry: name the counter
    // "account.fetch"
     ...
     *
     * TODO-12: Add Timer metric - Add @Timed annotation to this method - Set
     * the metric name to "account.timer" - Set a extra tag with
     ...
     * ----------------------------------------------------
     *
     * TODO-13: Add Timer metric - Add @Timed annotation to this method - Set
     * the metric name to "account.timer" - Set extra tag with
     * "source"/"accountDetails" key/value pair
     */
    ...
    public void removeBeneficiary(@PathVariable long accountId, @PathVariable String beneficiaryName) {
        ...
        if (account.getBeneficiaries().size() != 1
            ...
            // This logic is very simplistic, doesn't account for rounding
            // errors
     ...
     * http://localhost:8080/accounts and resourceId is "12345". Then the URL of
     * the new resource will be http://localhost:8080/accounts/12345.
     */
