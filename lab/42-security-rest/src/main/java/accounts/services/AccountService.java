...
public class AccountService {
    ...
    public List<String> getAuthoritiesForUser(String username) {
        ...
        // - Restart the application (or let Spring Boot Devtools to restart the
        // app)
        ...
        Collection<? extends GrantedAuthority> grantedAuthorities = authentication.getAuthorities(); // Modify
        // this
        // line
