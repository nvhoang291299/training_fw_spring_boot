...
public class JdbcRestaurantRepository implements RestaurantRepository {
     ...
     * from the rows in the T_RESTAURANT table. Cached restaurants are indexed
     * by their merchant numbers. This method should be called on
     * initialization.
     */

    /*
     * TODO-09: Make this method to be invoked after a bean gets created - Mark
     * this method with an annotation that will cause it to be executed by
     * Spring after constructor & setter initialization has occurred. - Re-run
     * the RewardNetworkTests test. You should see the test succeeds. - Note
     * that populating the cache is not really a valid construction activity, so
     * using a post-construct, rather than the constructor, is a better
     * practice.
     */
    @PostConstruct
     ...
     * Re-run RewardNetworkTests. - Observe this method is not called. - Use an
     * appropriate annotation to register this method for a destruction
     * lifecycle callback. - Re-run the test and you should be able to see that
     * this method is now being called.
     */
    @PreDestroy
