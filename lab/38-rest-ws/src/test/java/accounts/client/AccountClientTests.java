...
public class AccountClientTests {
    ...
    public void listAccounts() {
        ...
        // - Then, use the restTemplate to retrieve an array containing all
        // Account instances.
        ...
        accounts = restTemplate.getForObject(url, Account[].class);
    ...
    public void getAccount() {
        ...
        // - Remove the @Disabled on this test method.
        // - Then, use the restTemplate to retrieve the Account with id 0 using
        // a URI template
        // - Run the test and ensure that it passes.
    ...
    public void createAccount() {
        ...
        String url = BASE_URL + "/accounts/";
        URI newAccountLocation = null; // Modify this line to use the
                                       // restTemplate
        newAccountLocation = restTemplate.postForLocation(url, account);
        ...
        Account retrievedAccount = null; // Modify this line to use the
                                         // restTemplate
    ...
    public void addAndDeleteBeneficiary() {
        ...
        // (POST the String "David" to the "/accounts/{accountId}/beneficiaries"
        // URL).
        // - Store the returned location URI in a variable.
        String url = BASE_URL + "/accounts/{accountId}/beneficiaries";

        URI newBeneficiaryLocation = null; // Modify this line to use the
        // restTemplate
        newBeneficiaryLocation = restTemplate.postForLocation(url, "David", 1);

        // TODO-14: Retrieve the Beneficiary you just created from the location
        // that was returned
        Beneficiary newBeneficiary = null; // Modify this line to use the
                                           // restTemplate
        newBeneficiary = restTemplate.getForObject(newBeneficiaryLocation, Beneficiary.class);
        ...
        HttpClientErrorException httpClientErrorException = assertThrows(HttpClientErrorException.class, () -> {
            ...
            // - Run this test, then. It should pass because we expect a 404 Not
            // Found
