...
public class AccountController {
     ...
     * http://localhost:8080/accounts and resourceId is "1111". Then the URL of
     * the new resource will be http://localhost:8080/accounts/1111.
     */
    private ResponseEntity<Void> entityWithLocation(Object resourceId) {
        ...
        return ResponseEntity.created(location).build(); // Return something
                                                         // other than null
    }
    ...
    public ResponseEntity<Void> addBeneficiary(long accountId, String beneficiaryName) {
        ...
        // created beneficiary.
        // a. Use accountManager's addBeneficiary method to add a beneficiary to
        // an account
        // b. Use the entityWithLocation method - like we did for
        // createAccount().
        accountManager.addBeneficiary(accountId, beneficiaryName);
        return entityWithLocation("add benefitciary success!!!"); // Modify this
                                                                  // to return
                                                                  // something
    }
    ...
    @DeleteMapping("/accountId/{accountId}/beneficiaries/{beneficiaryName}")
