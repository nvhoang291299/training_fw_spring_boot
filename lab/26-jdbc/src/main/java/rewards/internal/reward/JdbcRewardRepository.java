...
public class JdbcRewardRepository implements RewardRepository {
    ...
    public RewardConfirmation confirmReward(AccountContribution contribution, Dining dining) {
        ...
        // throw new RuntimeException("SQL exception occurred inserting reward
        // record", e);
        // }
        jdbcTemplate.update(sql, confirmationNumber, contribution.getAmount().asBigDecimal(),
                SimpleDate.today().inMilliseconds(), contribution.getAccountNumber(), dining.getMerchantNumber(),
                dining.getDate().inMilliseconds(), dining.getAmount().asBigDecimal());
    ...
    private String nextConfirmationNumber() {
        ...
        // } catch (SQLException e) {
        // throw new RuntimeException("SQL exception getting next confirmation
        // number", e);
        // }
