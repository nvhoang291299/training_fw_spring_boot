...
public class JdbcRewardRepositoryTests {
    ...
    private void verifyRewardInserted(RewardConfirmation confirmation, Dining dining) throws SQLException {
        ...
        // - Use "SELECT * FROM T_REWARD WHERE CONFIRMATION_NUMBER = ?" as SQL
        // statement
    ...
    private int getRewardCount() throws SQLException {
        // TODO-01: Use JdbcTemplate to query for the number of rows in the
        // T_REWARD table
        // - Use "SELECT count(*) FROM T_REWARD" as SQL statement
        int result = jdbcTemplate.queryForObject("SELECT count(*) FROM T_REWARD", Integer.class);
        return result;
    }
