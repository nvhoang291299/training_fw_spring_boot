...
public class RewardNetworkTests {
    ...
    public void testRewardForDining(OutputCapture capture) {
        ...
        // TODO-06: Run this test. It should pass AND you should see TWO lines
        // of
        // log output from the LoggingAspect on the console
        int expectedMatches = 4;
        checkConsoleOutput(capture, expectedMatches);

        // TODO-09: Save all your work, and change the expected matches value
        // above from 2 to 4.
        // Rerun the RewardNetworkTests. It should pass, and you should now see
        // FOUR lines of
