...
public class AccountClientTests {
    ...
    // TODO-04: Modify the code below so that it handles 404 HTTP response
    // status
    ...
    public void addAndDeleteBeneficiary() {
        ...
        ResponseEntity responseEntity = restTemplate.getForEntity(newBeneficiaryLocation, Beneficiary.class);
